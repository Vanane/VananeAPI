...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DICEOP = 4,                     /* DICEOP  */
  YYSYMBOL_INTOP = 5,                      /* INTOP  */
  ...
  YYSYMBOL_dAdd = 13,                      /* dAdd  */
  YYSYMBOL_dOp = 14,                       /* dOp  */
  YYSYMBOL_dMod = 15,                      /* dMod  */
  YYSYMBOL_dice = 16                       /* dice  */
};
...
{
       0,    56,    56,    62,    63,    64,    65,    68,   102,   111,
     112,   115,   133
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "DICEOP",
  "INTOP", "NEWLINE", "'('", "')'", "$accept", "S", "expr", "mult", "dAdd",
  "dOp", "dMod", "dice", YY_NULLPTR
};
...
{
      14,    10,     1,    12,    11,    12,     2,     2,    15,    16,
      17,    10,    18,     0,    22,    23,    13,    19,    20,    24,
...
{
       0,     3,     7,    10,    11,    12,    13,    14,    15,    16,
       4,     7,     3,    15,    16,     0,     5,     5,     3,    11,
       8,    14,    16,     3,     8
};
...
#line 1183 "y.tab.c"
  ...
  case 7: /* mult: NUMBER '(' expr ')'  */
#line 69 "dice.y"
            {
                throwCountSentinel *= (yyvsp[-3].number);
                nestCountSentinel += 1;
                ...
                else 
                {
                    ...
                    memcpy(S1, &((yyvsp[-3].number)), sizeof(int));
...
#line 1230 "y.tab.c"
  ...
  case 11: /* dMod: dice INTOP NUMBER  */
#line 116 "dice.y"
            {            
                int * S3 = malloc(sizeof(int));
            
                memcpy(S3, &((yyvsp[0].number)), sizeof(int));
...
#line 1250 "y.tab.c"
  ...
  case 12: /* dice: NUMBER DICEOP NUMBER  */
#line 134 "dice.y"
            {
                throwCountSentinel += (yyvsp[-2].number);
                if(throwCountSentinel > MAXIMUM_THROWS)
                {
                    char err[256];
                    snprintf(err, 256, "Value error : nested dice count limit exceeded (%d > %d)", throwCountSentinel, MAXIMUM_THROWS);
                ...
                else if((yyvsp[-2].number) > MAXIMUM_DICE_COUNT)
                {
                    char err[256];
                    snprintf(err, 256, "Value error : dice count limit exceeded (%d > %d)", (yyvsp[-2].number), MAXIMUM_DICE_COUNT);
                    yyerror(err);
                    YYABORT;
                }
                else
                {
                    ...
                    memcpy(S1, &((yyvsp[-2].number)), sizeof(int));
                    memcpy(S3, &((yyvsp[0].number)), sizeof(int));
